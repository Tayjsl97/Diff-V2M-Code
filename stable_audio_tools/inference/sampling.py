...
@torch.no_grad()
def sample(model, x, steps, eta, class_label=None, callback=None, sigma_max=1.0, dist_shift=None, cfg_pp=False, **extra_args):
    ...
    for i in trange(steps):
        ...
        if cfg_pp:
            ...
            v, info = model(x=x, t=ts * t[i], class_label=class_label, return_info=True, **extra_args)
            ...
            v = model(x=x, t=ts * t[i],class_label=class_label, **extra_args)
            v_eps = v
